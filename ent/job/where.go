...
func UserID(v uuid.UUID) predicate.Job {
	return predicate.Job(func(s *sql.Selector) {
...
func Timezone(v string) predicate.Job {
	return predicate.Job(func(s *sql.Selector) {
...
func UserIDEQ(v uuid.UUID) predicate.Job {
	return predicate.Job(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldUserID), v))
	})
}
...
func UserIDNEQ(v uuid.UUID) predicate.Job {
	return predicate.Job(func(s *sql.Selector) {
...
func UserIDIn(vs ...uuid.UUID) predicate.Job {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func UserIDNotIn(vs ...uuid.UUID) predicate.Job {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func UserIDIsNil() predicate.Job {
	return predicate.Job(func(s *sql.Selector) {
...
func TimezoneEQ(v string) predicate.Job {
	return predicate.Job(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldTimezone), v))
	})
}
...
func TimezoneNEQ(v string) predicate.Job {
	return predicate.Job(func(s *sql.Selector) {
...
func TimezoneIn(vs ...string) predicate.Job {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func TimezoneNotIn(vs ...string) predicate.Job {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func TimezoneGT(v string) predicate.Job {
	return predicate.Job(func(s *sql.Selector) {
...
func TimezoneGTE(v string) predicate.Job {
	return predicate.Job(func(s *sql.Selector) {
...
func TimezoneLT(v string) predicate.Job {
	return predicate.Job(func(s *sql.Selector) {
...
func TimezoneLTE(v string) predicate.Job {
	return predicate.Job(func(s *sql.Selector) {
...
func TimezoneContains(v string) predicate.Job {
	return predicate.Job(func(s *sql.Selector) {
...
func TimezoneHasPrefix(v string) predicate.Job {
	return predicate.Job(func(s *sql.Selector) {
...
func TimezoneHasSuffix(v string) predicate.Job {
	return predicate.Job(func(s *sql.Selector) {
...
func TimezoneEqualFold(v string) predicate.Job {
	return predicate.Job(func(s *sql.Selector) {
...
func TimezoneContainsFold(v string) predicate.Job {
	return predicate.Job(func(s *sql.Selector) {
...
// HasJobFileUpload applies the HasEdge predicate on the "job_file_upload" edge.
func HasJobFileUpload() predicate.Job {
	return predicate.Job(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(JobFileUploadTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2O, true, JobFileUploadTable, JobFileUploadColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasJobFileUploadWith applies the HasEdge predicate on the "job_file_upload" edge with a given conditions (other predicates).
func HasJobFileUploadWith(preds ...predicate.JobFileUpload) predicate.Job {
	return predicate.Job(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(JobFileUploadInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2O, true, JobFileUploadTable, JobFileUploadColumn),
		)
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
...
// HasJobPayments applies the HasEdge predicate on the "job_payments" edge.
func HasJobPayments() predicate.Job {
	return predicate.Job(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(JobPaymentsTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, JobPaymentsTable, JobPaymentsColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasJobPaymentsWith applies the HasEdge predicate on the "job_payments" edge with a given conditions (other predicates).
func HasJobPaymentsWith(preds ...predicate.JobPayment) predicate.Job {
	return predicate.Job(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(JobPaymentsInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, JobPaymentsTable, JobPaymentsColumn),
		)
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
