...
type SlackAppInstallEdges struct {
	...
	// SlackAppUsers holds the value of the slack_app_users edge.
	SlackAppUsers []*SlackAppUser `json:"slack_app_users,omitempty"`
...
// SlackAppUsersOrErr returns the SlackAppUsers value or an error if the edge
// was not loaded in eager-loading.
func (e SlackAppInstallEdges) SlackAppUsersOrErr() ([]*SlackAppUser, error) {
	if e.loadedTypes[1] {
		return e.SlackAppUsers, nil
	}
	return nil, &NotLoadedError{edge: "slack_app_users"}
}
...
// QuerySlackAppUsers queries the "slack_app_users" edge of the SlackAppInstall entity.
func (sai *SlackAppInstall) QuerySlackAppUsers() *SlackAppUserQuery {
	return (&SlackAppInstallClient{config: sai.config}).QuerySlackAppUsers(sai)
}
