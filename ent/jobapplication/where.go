...
func ApplicantID(v int) predicate.JobApplication {
	return predicate.JobApplication(func(s *sql.Selector) {
...
func ApplicantIDEQ(v int) predicate.JobApplication {
	return predicate.JobApplication(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldApplicantID), v))
	})
}
...
func ApplicantIDNEQ(v int) predicate.JobApplication {
	return predicate.JobApplication(func(s *sql.Selector) {
...
func ApplicantIDIn(vs ...int) predicate.JobApplication {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func ApplicantIDNotIn(vs ...int) predicate.JobApplication {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func ApplicantIDIsNil() predicate.JobApplication {
	return predicate.JobApplication(func(s *sql.Selector) {
...
func ApplicantIDNotNil() predicate.JobApplication {
	return predicate.JobApplication(func(s *sql.Selector) {
...
func HasApplicant() predicate.JobApplication {
	return predicate.JobApplication(func(s *sql.Selector) {
...
func HasApplicantWith(preds ...predicate.Applicant) predicate.JobApplication {
	return predicate.JobApplication(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
