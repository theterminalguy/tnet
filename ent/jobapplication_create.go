...
func (jac *JobApplicationCreate) SetApplicantID(i int) *JobApplicationCreate {
	jac.mutation.SetApplicantID(i)
	return jac
}

// SetNillableApplicantID sets the "applicant_id" field if the given value is not nil.
func (jac *JobApplicationCreate) SetNillableApplicantID(i *int) *JobApplicationCreate {
	if i != nil {
		jac.SetApplicantID(*i)
	}
	return jac
}
...
func (jac *JobApplicationCreate) createSpec() (*JobApplication, *sqlgraph.CreateSpec) {
	...
	if nodes := jac.mutation.ApplicantIDs(); len(nodes) > 0 {
