...
func TalentID(v int) predicate.Skill {
	return predicate.Skill(func(s *sql.Selector) {
...
func TalentIDEQ(v int) predicate.Skill {
	return predicate.Skill(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldTalentID), v))
	})
}
...
func TalentIDNEQ(v int) predicate.Skill {
	return predicate.Skill(func(s *sql.Selector) {
...
func TalentIDIn(vs ...int) predicate.Skill {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func TalentIDNotIn(vs ...int) predicate.Skill {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func TalentIDIsNil() predicate.Skill {
	return predicate.Skill(func(s *sql.Selector) {
...
func TalentIDNotNil() predicate.Skill {
	return predicate.Skill(func(s *sql.Selector) {
...
func HasTalent() predicate.Skill {
	return predicate.Skill(func(s *sql.Selector) {
...
func HasTalentWith(preds ...predicate.Talent) predicate.Skill {
	return predicate.Skill(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
