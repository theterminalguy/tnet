...
func (jau *JobApplicationUpdate) SetNillableApplicantID(i *int) *JobApplicationUpdate {
	if i != nil {
		jau.SetApplicantID(*i)
	}
	return jau
}

// ClearApplicantID clears the value of the "applicant_id" field.
func (jau *JobApplicationUpdate) ClearApplicantID() *JobApplicationUpdate {
	jau.mutation.ClearApplicantID()
	return jau
}
...
func (jau *JobApplicationUpdate) ClearApplicant() *JobApplicationUpdate {
	jau.mutation.ClearApplicant()
	return jau
}
...
func (jau *JobApplicationUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if jau.mutation.ApplicantCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   jobapplication.ApplicantTable,
			Columns: []string{jobapplication.ApplicantColumn},
			Bidi:    false,
	...
	if nodes := jau.mutation.ApplicantIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   jobapplication.ApplicantTable,
...
// SetApplicantID sets the "applicant_id" field.
func (jauo *JobApplicationUpdateOne) SetApplicantID(i int) *JobApplicationUpdateOne {
	jauo.mutation.SetApplicantID(i)
	return jauo
}

// SetNillableApplicantID sets the "applicant_id" field if the given value is not nil.
func (jauo *JobApplicationUpdateOne) SetNillableApplicantID(i *int) *JobApplicationUpdateOne {
	if i != nil {
		jauo.SetApplicantID(*i)
	}
	return jauo
}

// ClearApplicantID clears the value of the "applicant_id" field.
func (jauo *JobApplicationUpdateOne) ClearApplicantID() *JobApplicationUpdateOne {
	jauo.mutation.ClearApplicantID()
	return jauo
}
...
// SetApplicant sets the "applicant" edge to the Applicant entity.
func (jauo *JobApplicationUpdateOne) SetApplicant(a *Applicant) *JobApplicationUpdateOne {
	return jauo.SetApplicantID(a.ID)
}
...
// ClearApplicant clears the "applicant" edge to the Applicant entity.
func (jauo *JobApplicationUpdateOne) ClearApplicant() *JobApplicationUpdateOne {
	jauo.mutation.ClearApplicant()
	return jauo
}
...
func (jauo *JobApplicationUpdateOne) sqlSave(ctx context.Context) (_node *JobApplication, err error) {
	...
	if jauo.mutation.ApplicantCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   jobapplication.ApplicantTable,
	...
	if nodes := jauo.mutation.ApplicantIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   jobapplication.ApplicantTable,
